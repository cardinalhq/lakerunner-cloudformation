...
class TestEcsCollectorTemplate:
    """Test cases for the ECS Collector CloudFormation template"""

    def test_load_otel_config_function(self):
        """Test that the load_otel_config function exists and is importable"""
        from lakerunner_ecs_collector import load_otel_config
    ...
    def test_load_default_otel_yaml_function(self):
        ...
        from lakerunner_ecs_collector import load_default_otel_yaml
    ...
    def test_create_otel_collector_template_function(self):
        ...
        from lakerunner_ecs_collector import create_otel_collector_template
        assert callable(create_otel_collector_template)

    @patch('lakerunner_ecs_collector.load_otel_config')
    @patch('lakerunner_ecs_collector.load_default_otel_yaml')
...
"""
    ...
    def test_template_has_required_parameters(self):
        ...
        with patch('lakerunner_ecs_collector.load_otel_config', return_value=mock_config), \
             patch('lakerunner_ecs_collector.load_default_otel_yaml', return_value=mock_yaml_content):
